          ...
          <div className="mt-10 lg:flex items-center justify-between gap-2">
            <ul className="flex items-center justify-between bg-slate-100 py-2 px-4 rounded shadow lg:flex-1">
              <li className="cursor-pointer">
                <img src="./images/icon-minus.svg" alt="-" onClick={() => setAmount(amount - 1)} />
              </li>
              <li>
                <span>{amount >= 0 ? amount : 0}</span>
              </li>
              <li className="cursor-pointer">
                <img src="./images/icon-plus.svg" alt="+" onClick={() => setAmount(amount + 1)} />
              </li>
            </ul>
            <div className="text-center lg:flex-1">
              <button
                className="flex items-center gap-4 bg-orange-500 py-2 px-4 justify-center lg:mt-0
           text-white rounded-lg shadow font-bold mt-5 w-full hover:bg-orange-600 transition-all duration-200"
              >
